...
ModelDict = {}
errorPredictions = open("model_errors_global_area_dataset_TTDS_v2.1_1F_more100SAM.txt",'a')
errorPredictionsTree = open("model_errorsTree_Global_reg_dataset_TTDS_v2.1_1F_more100SAM.txt",'a')
...
# new transformed dataset:  nxtLoc <-- CurrTimeInt+ CurrLoc+ NxtTimeInt
...
errorPredictions.write("Test_Error=: "+str(testErr)+" Time_taken: "+str((time.time() - start_time))+" trainRDDCount:"+str(trainRDD.count())+" testRDDCount: "+ str(testRDD.count())+'\n')
