...
logFile = '/home/..../Sample_small_input'
...
model = DecisionTree.trainClassifier(trainingData, numClasses=10001, categoricalFeaturesInfo={}, impurity='gini', maxDepth=15, maxBins=62)
